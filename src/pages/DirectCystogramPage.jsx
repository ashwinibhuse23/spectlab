...
import { CheckCircle2, AlertCircle, FlaskConical, Activity, Download } from 'lucide-react';
import { gsap } from 'gsap';

export default function DirectCystogramPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  const techniqueSteps = [
    '2 mci 99mTc-DTPA is administered into the bladder via supra pubic puncture under aseptic conditions.',
    'This is followed by an appropriate volume of sterile normal saline.',
    'The filling and voiding images are acquired continuously with the patient lying supine.',
    'Post void static image is also acquired at the end of the procedure.',
  ];
