...
export default function MeckelsDiverticulumPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  const procedureSteps = [
    '99mTc is injected intravenously under the camera.',
    'Dynamic images are acquired for 30 minutes immediately thereafter of the anterior abdomen.',
    'Followed by static images of the LAO & RAO views.',
    'Post void static image of the abdomen is also acquired.',
  ];
    ...
    <div className="bg-white min-h-screen pt-28 pb-20 lg:pt-36 lg:pb-28">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-20">
          <h1 className="font-display font-extrabold text-navy text-lg md:text-xl lg:text-2xl mb-6 max-w-2xl mx-auto whitespace-nowrap">
