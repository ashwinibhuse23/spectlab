...
export default function DtpaRenalScanPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
    ...
    <div className="bg-white min-h-screen pt-28 pb-20 lg:pt-36 lg:pb-28">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-20">
          <h1 className="font-display font-extrabold text-navy text-lg md:text-xl lg:text-2xl mb-4 flex flex-col gap-1 max-w-3xl mx-auto">
            <span>DTPA RENOGRAM (GLOMERULAR FUNCTION) /</span>
            <span>EC (MAG-3) RENOGRAM (GLOM+ TUBULAR FUNCTION)</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-12 items-start">
          ...
          <section>
            ...
            <div className="ml-1 md:ml-3 procedure-text space-y-4">
              <p className="text-navy text-[15px] leading-relaxed">
                Tc99m DTPA is injected IV after ensuring good hydration of the patient.
              </p>
              <p className="text-navy text-[15px] leading-relaxed">
                I.V. lasix is given after 10 mins of tracer injection.
              </p>
              <p className="text-navy text-[15px] leading-relaxed">
                Sequential dynamic images are obtained for 31 minutes followed by post void and 1hour delayed image.
              </p>
            </div>
          </section>
