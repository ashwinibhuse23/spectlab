...
export default function HepatobiliaryScintigraphyPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  const procedureSteps = [
    '2 mCi 99m Tc Mebrofenin is injected intravenously after skipping one normal feed.',
    'Dynamic images are obtained for 20 minutes.',
    'Second set of dynamic images are obtained post feed for 20 minutes.',
    'Delayed static images may be acquired till 24 hours if required.',
  ];
