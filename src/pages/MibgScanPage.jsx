...
export default function MibgScanPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  const procedureSteps = [
    'Orally one tea spoon twice a day of Colloidal Iodine solution is started 2 days prior to injection and continued throughout the study.',
    '131 I MIBG (Meta Iodo Benzyl Guanidine) is injected intravenously.',
    'Whole body views of the upper torso (Anterior and Posterior) are acquired at 24 & 48, 72 hours (5 mins each).',
  ];
