...
export default function DmsaRenalScanPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  const procedureSteps = [
    'Tc99m DMSA is injected intravenously after ensuring good hydration of the patient.',
    'Static images in posterior, LPO & RPO views are acquired at 2.5 hrs post injection.',
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-20">
          <h1 className="font-display font-extrabold text-navy text-lg md:text-xl lg:text-2xl mb-6 flex flex-col gap-3 max-w-2xl mx-auto">
            <span>DMSA RENAL SCAN</span>
            <span>(CORTICAL FUNCTION)</span>
          </h1>
