...
export default function LymphoscintigraphyPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  const postProcedure = [
    'No specific post procedure instructions.',
  ];

  const indications = [
    'To differentiate lymphoedema from venous pathology.',
    'Assessment of lymphatic drainage disorders.',
    'Evaluation of lymph node mapping prior to surgery.',
  ];
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <div className="ml-1 md:ml-3">
                <p className="text-navy text-[15px] leading-relaxed">None.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="ml-1 md:ml-3">
                <p className="text-navy text-[15px] leading-relaxed">
                  Procedure Imaging Time: 30 to 60 mins. &nbsp;|&nbsp; Total Time with Reporting: 2 – 3 hrs.
                </p>
              </div>
            </section>
            ...
            <section>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="font-display font-bold text-navy text-lg md:text-xl">Post Procedure Instructions</h2>
              </div>
