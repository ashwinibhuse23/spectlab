...
export default function RbcBloodPoolScanPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  const procedureSteps = [
    'Invivo RBC Labeling Method: 20 minutes after the intravenous administration of stannous pyrophosphate (cold Kit), 10 mCi of 99m Tc (O4-) is injected intravenously.',
    'The patient is positioned supine covering the anterior abdomen.',
    'Perfusion images (2 sec/fr × 60 frames) are acquired, followed by dynamic images (1 min/fr × 60 frames).',
    'Thereafter, delayed static images are acquired.',
    'If required, TOMO (tomographic) images may also be acquired.',
  ];
